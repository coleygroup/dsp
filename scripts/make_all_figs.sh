...
python scripts/figures.py prob_single ./data/michalewicz-prob michalewicz -o $DIR/mich-prob_single.${FMT}
python scripts/figures.py prob_triple ./data/michalewicz-prob michalewicz -o $DIR/mich-prob_triple.${FMT}
